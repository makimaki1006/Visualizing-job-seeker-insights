...
def normalize_workstyle(workstyle_str):
    ...
    # カテゴリ正規化
    if '正職員' in workstyle or '正社員' in workstyle:
        return '正職員'
...
class MapCompleteCompleteSheetGenerator:
    ...
    def _fix_prefecture_names(self, df):
        """都道府県名正規化（「京都」→「京都府」等）"""
        PREF_NORMALIZE = {
            '京都': '京都府', '大阪': '大阪府', '東京': '東京都',
            '兵庫': '兵庫県', '神奈川': '神奈川県', '和歌山': '和歌山県',
            '鹿児島': '鹿児島県', '愛知': '愛知県', '福岡': '福岡県',
            '広島': '広島県', '宮城': '宮城県', '静岡': '静岡県',
            '千葉': '千葉県', '埼玉': '埼玉県', '茨城': '茨城県',
            '栃木': '栃木県', '群馬': '群馬県', '岐阜': '岐阜県',
            '三重': '三重県', '滋賀': '滋賀県', '奈良': '奈良県',
            '福島': '福島県', '新潟': '新潟県', '長野': '長野県',
            '山梨': '山梨県', '石川': '石川県', '富山': '富山県',
            '福井': '福井県', '岡山': '岡山県', '山口': '山口県',
            '島根': '島根県', '鳥取': '鳥取県', '徳島': '徳島県',
            '香川': '香川県', '愛媛': '愛媛県', '高知': '高知県',
            '佐賀': '佐賀県', '長崎': '長崎県', '熊本': '熊本県',
            '大分': '大分県', '宮崎': '宮崎県', '沖縄': '沖縄県',
            '岩手': '岩手県', '秋田': '秋田県', '山形': '山形県',
            '青森': '青森県',
        }
        fixed_count = 0
