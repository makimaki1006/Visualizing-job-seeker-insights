...
class PerfectJobSeekerAnalyzer:
    ...
    def export_phase1(self, output_dir='data/output_v2/phase1'):
        ...
        qual_master_df.to_csv(output_path / 'QualificationMaster.csv', index=False, encoding='utf-8-sig')
        print(f"  [OK] QualificationMaster.csv: {len(qual_master_df)}件")

        # 7-2. 都道府県マスタ
        pref_master_df = self._generate_prefecture_master()
        pref_master_df.to_csv(output_path / 'PrefectureMaster.csv', index=False, encoding='utf-8-sig')
        print(f"  [OK] PrefectureMaster.csv: {len(pref_master_df)}件")

        # 7-3. 就業状況マスタ
        emp_master_df = self._generate_employment_status_master()
        emp_master_df.to_csv(output_path / 'EmploymentStatusMaster.csv', index=False, encoding='utf-8-sig')
        ...
        persona_residence_df.to_csv(output_path / 'PersonaByMunicipality_WithResidence.csv', index=False, encoding='utf-8-sig')
        ...
        qual_dist_df.to_csv(output_path / 'QualificationDistributionByMunicipality.csv', index=False, encoding='utf-8-sig')
    ...
    def export_phase3(self, output_dir='data/output_v2/phase3'):
        ...
        # 3. CSV保存
        persona_summary.to_csv(output_path / 'PersonaSummary.csv', index=False, encoding='utf-8-sig')
        print(f"  [OK] PersonaSummary.csv: {len(persona_summary)}件")

        persona_details.to_csv(output_path / 'PersonaDetails.csv', index=False, encoding='utf-8-sig')
        ...
        if not persona_by_muni.empty:
            persona_by_muni.to_csv(output_path / 'PersonaSummaryByMunicipality.csv', index=False, encoding='utf-8-sig')
    ...
    def export_phase6(self, output_dir='data/output_v2/phase6'):
        ...
        # 3. CSV保存
        flow_edges.to_csv(output_path / 'MunicipalityFlowEdges.csv', index=False, encoding='utf-8-sig')
        print(f"  [OK] MunicipalityFlowEdges.csv: {len(flow_edges)}件")

        flow_nodes.to_csv(output_path / 'MunicipalityFlowNodes.csv', index=False, encoding='utf-8-sig')
        print(f"  [OK] MunicipalityFlowNodes.csv: {len(flow_nodes)}件")

        proximity_analysis.to_csv(output_path / 'ProximityAnalysis.csv', index=False, encoding='utf-8-sig')
    ...
    def export_phase7(self, output_dir='data/output_v2/phase7'):
        ...
        # 3. CSV保存
        supply_density.to_csv(output_path / 'SupplyDensityMap.csv', index=False, encoding='utf-8-sig')
        print(f"  [OK] SupplyDensityMap.csv: {len(supply_density)}件")

        qualification_dist.to_csv(output_path / 'QualificationDistribution.csv', index=False, encoding='utf-8-sig')
        print(f"  [OK] QualificationDistribution.csv: {len(qualification_dist)}件")

        age_gender_cross.to_csv(output_path / 'AgeGenderCrossAnalysis.csv', index=False, encoding='utf-8-sig')
        print(f"  [OK] AgeGenderCrossAnalysis.csv: {len(age_gender_cross)}件")

        mobility_score.to_csv(output_path / 'MobilityScore.csv', index=False, encoding='utf-8-sig')
        print(f"  [OK] MobilityScore.csv: {len(mobility_score)}件")

        persona_profile.to_csv(output_path / 'DetailedPersonaProfile.csv', index=False, encoding='utf-8-sig')
    ...
    def export_phase8(self, output_dir='data/output_v2/phase8'):
        ...
        # 3. CSV保存
        career_dist.to_csv(output_path / 'CareerDistribution.csv', index=False, encoding='utf-8-sig')
        print(f"  [OK] CareerDistribution.csv: {len(career_dist)}件")

        career_age_cross.to_csv(output_path / 'CareerAgeCross.csv', index=False, encoding='utf-8-sig')
        print(f"  [OK] CareerAgeCross.csv: {len(career_age_cross)}件")

        career_age_matrix.to_csv(output_path / 'CareerAgeCross_Matrix.csv', index=True, encoding='utf-8-sig')
        ...
        if graduation_year_dist is not None and len(graduation_year_dist) > 0:
            graduation_year_dist.to_csv(output_path / 'GraduationYearDistribution.csv', index=False, encoding='utf-8-sig')
    ...
    def export_phase10(self, output_dir='data/output_v2/phase10'):
        ...
        # 3. CSV保存
        urgency_dist.to_csv(output_path / 'UrgencyDistribution.csv', index=False, encoding='utf-8-sig')
        print(f"  [OK] UrgencyDistribution.csv: {len(urgency_dist)}件")

        urgency_age_cross.to_csv(output_path / 'UrgencyAgeCross.csv', index=False, encoding='utf-8-sig')
        print(f"  [OK] UrgencyAgeCross.csv: {len(urgency_age_cross)}件")

        urgency_age_matrix.to_csv(output_path / 'UrgencyAgeCross_Matrix.csv', index=True, encoding='utf-8-sig')
        print(f"  [OK] UrgencyAgeCross_Matrix.csv: {urgency_age_matrix.shape[0]}行 x {urgency_age_matrix.shape[1]}列")

        urgency_employment_cross.to_csv(output_path / 'UrgencyEmploymentCross.csv', index=False, encoding='utf-8-sig')
        print(f"  [OK] UrgencyEmploymentCross.csv: {len(urgency_employment_cross)}件")

        urgency_employment_matrix.to_csv(output_path / 'UrgencyEmploymentCross_Matrix.csv', index=True, encoding='utf-8-sig')
        print(f"  [OK] UrgencyEmploymentCross_Matrix.csv: {urgency_employment_matrix.shape[0]}行 x {urgency_employment_matrix.shape[1]}列")

        urgency_by_muni.to_csv(output_path / 'UrgencyByMunicipality.csv', index=False, encoding='utf-8-sig')
        print(f"  [OK] UrgencyByMunicipality.csv: {len(urgency_by_muni)}件")

        urgency_age_muni.to_csv(output_path / 'UrgencyAgeCross_ByMunicipality.csv', index=False, encoding='utf-8-sig')
        print(f"  [OK] UrgencyAgeCross_ByMunicipality.csv: {len(urgency_age_muni)}件")

        urgency_employment_muni.to_csv(output_path / 'UrgencyEmploymentCross_ByMunicipality.csv', index=False, encoding='utf-8-sig')
