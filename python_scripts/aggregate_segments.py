...
TEXT_FEATURE_DICT = {
    ...
    'dept_aesthetic': {
        'category': '診療科目',
        'label': '美容医療',
        'patterns': [r'美容(外科|皮膚科?|クリニック|整形|医療)?',
                     r'AGA(クリニック|治療)?', r'脱毛(クリニック)?', r'痩身',
                     r'ボトックス', r'ヒアルロン酸', r'豊胸', r'二重(整形|手術)'],
        'fields': ['service_type', 'facility_name', 'job_description', 'headline'],
    },
    'dept_checkup': {
        'category': '診療科目',
        'label': '健診・予防',
        'patterns': [r'健(康)?診(センター|クリニック)?', r'検診', r'人間ドック',
                     r'予防接種', r'ワクチン', r'特定健診', r'がん検診',
                     r'乳(がん|癌)検診', r'健康診断'],
        'fields': ['service_type', 'job_description', 'headline'],
    },
    'dept_endoscopy': {
        'category': '診療科目',
        'label': '内視鏡',
        'patterns': [r'内視鏡(検査|室|センター)?', r'胃カメラ', r'大腸カメラ',
                     r'上部消化管', r'下部消化管'],
    ...
    'dept_ope': {
        'category': '診療科目',
        'label': '手術室',
        'patterns': [r'手術(室|場|センター)', r'オペ(室|ナース|看護|介助)',
                     r'手術(介助|看護)', r'術前(・術後)?'],
        'fields': ['job_description', 'headline'],
    },
    'dept_occupational': {
        'category': '診療科目',
        'label': '産業保健',
        'patterns': [r'産業(看護|保健|医|ナース)', r'企業.{0,3}(看護|保健|健康管理)',
                     r'事業所.{0,3}(看護|保健)', r'健康経営', r'ストレスチェック'],
        'fields': ['service_type', 'job_description', 'headline'],
    },
    'dept_infection': {
        'category': '診療科目',
        'label': '感染管理',
        'patterns': [r'感染(管理|対策|制御|予防)', r'ICT.{0,3}(感染|活動|委員)',
                     r'感染症(科|病棟|対応)', r'感染管理(認定)?看護師'],
        'fields': ['job_description', 'headline'],
    },
    'dept_fertility': {
        'category': '診療科目',
        'label': '不妊治療',
        'patterns': [r'不妊(治療|クリニック|外来|相談)?', r'体外受精',
                     r'生殖(医療|補助)', r'人工授精', r'IVF', r'胚移植',
                     r'顕微授精', r'採卵'],
        'fields': ['service_type', 'facility_name', 'job_description', 'headline'],
    },
    'dept_anesthesia_pain': {
        'category': '診療科目',
        'label': '麻酔・ペイン',
        'patterns': [r'麻酔(科)?', r'ペイン(クリニック|外来)?',
                     r'疼痛(外来|治療|管理)', r'神経ブロック'],
        'fields': ['job_description', 'headline'],
    },
    # --- 勤務形態 ---
    'work_nightshift': {
